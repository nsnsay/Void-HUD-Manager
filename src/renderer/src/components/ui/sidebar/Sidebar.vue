...
<template>
  <div v-if="collapsible === 'none'" data-slot="sidebar" style="background-color: var(--background-alpha);"
    :class="cn('text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col', props.class)" v-bind="$attrs">
    <slot />
  </div>
